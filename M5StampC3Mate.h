#ifndef M5StampC3Mate_h
#define M5StampC3Mate_h

const char DeviceName[] = "M5 STAMP C3 Mate";
...
#define POWER_EXT     0        // GPIO-pin that monitors the voltage of the power supply
#define POWER_INT     1        // GPIO-pin that monitors the voltage of the controller
...
#define BUTTON_DOWN   7        // GPIO-pin for the Volume down button
#define BUTTON_RIGHT  8        // GPIO-pin for the Seek next button
